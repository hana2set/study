...
| Subscript (아래 첨자)             | `<sub> </sub>`   `$_{text}$`      | None                                                                                  | `This is a <sub>subscript</sub> text`    | This is a <sub>subscript</sub> text    |                                                   |
| Superscript (위 첨자)           | `<sup> </sup>`   `$^{text}$`    | None                                                                                  | `This is a <sup>superscript</sup> text`  | This is a <sup>superscript</sup> text  |                                                   |
